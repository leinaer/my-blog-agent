...
const filePath = path.join(process.cwd(), 'content/blog/prompt-engineering.mdx');
let content = fs.readFileSync(filePath, 'utf-8');

console.log('Fixing prompt-engineering.mdx...');
...
console.log('Fixed prompt-engineering.mdx - escaped all curly braces');
